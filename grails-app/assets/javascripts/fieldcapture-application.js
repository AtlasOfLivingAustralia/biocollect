...
function Documents() {
    ...
    self.documentFilterFieldOptions = [{ label: 'Filter by', fun: 'none'}, { label: 'No Filters', fun: 'none'}, { label: 'Name', fun: 'name'}, { label: 'Attribution', fun: 'attribution' }, { label: 'Type', fun: 'role' }, { label: 'Citation', fun: 'citation' }, { label: 'Keywords', fun: 'labels' }, { label: 'Description', fun: 'description' }];
