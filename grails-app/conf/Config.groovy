...
log4j = {
    appenders {
        environments {
            production {
                rollingFile name: "tomcatLog", maxFileSize: '1MB', file: "${loggingDir}/${appName}.log", threshold: org.apache.log4j.Level.ALL, layout: pattern(conversionPattern: "%d %-5p [%c{1}] %m%n")
            }
            development {
