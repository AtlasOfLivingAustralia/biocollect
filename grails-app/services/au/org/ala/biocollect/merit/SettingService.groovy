...
class SettingService {
    ...
    public Map getConfigurableHubTemplate1(String urlPath, Map styles) {
        ...
        "gettingStartedButtonBackgroundColor": styles?.gettingStartedButtonBackgroundColor?:'#fff',
        "gettingStartedButtonTextColor": styles?.gettingStartedButtonTextColor?:'#fff',
