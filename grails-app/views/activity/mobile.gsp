                            ...
                            <div class="row-fluid space-after">
                                ...
                                <div class="span6">
                                    ...
                                    <label for="activityComplete"><input type="checkbox" id="activityComplete"
                                                                         ...
                                                                         style="margin-right:1em;"><span>This activity is complete</span>
                                    </label>
    ...
    <g:each in="${metaModel?.outputs}" var="outputName">
        <g:if test="${outputName != 'Photo Points'}">
            ...
            <div class="output-block" id="ko${blockId}">
                ...
                <md:modelView model="${model}" site="${site}" edit="true" disableTableUpload="true"
                              output="${outputName}"/>
                <asset:script type="text/javascript">
                    $(function(){
            ...
            // load dynamic models - usually objects in a list
                ...
                // add declarations for dynamic data
                    <md:jsViewModel model="${model}" output="${outputName}" edit="true"
                                    viewModelInstance="${blockId}ViewModelInstance"/>
