...
<head>
    ...
    <asset:script type="text/javascript">
        ...
        activityDeleteAndReturnToUrl: "${raw(createLink(action: 'delete', id: activityId, params: [returnTo: grailsApplication.config.getProperty('grails.serverURL') + '/' + returnTo]))}",
