<div class="row-fluid">
    <div class="span2">
        <ul class="nav nav-tabs nav-stacked">
            <li class="active"><a href="#admin-actions" data-toggle="tab"><i class="icon-chevron-right"></i> Actions</a>
            </li>
    ...
    <div class="span10">
        <div class="pill-content">
            <div id="admin-actions" class="pill-pane active">
                ...
                <div class="row-fluid">
                    <p><button class="btn btn-small admin-action" data-bind="click:editOrganisation"><i
                            class="icon-edit"></i> Edit</button> Edit the organisation details and content</p>
                    <g:if test="${fc.userIsAlaOrFcAdmin()}"><p><button class="admin-action btn btn-small btn-danger"
                                                                       data-bind="click:deleteOrganisation"><i
                                class="icon-remove icon-white"></i> Delete
                    </button> Delete this organisation from the system. <strong>This cannot be undone</strong>
                    </p></g:if>
                </div>
            </div>
