<form class="form-horizontal validationEngineContainer">
    ...
    <div class="row-fluid">
        <div class="well">
            ...
            <div class="control-group required">
                <label class="control-label span3" for="name">Name: <fc:iconHelp><g:message
                        code="organisation.name.help"/></fc:iconHelp></label>

                <div class="controls span9">
                    <input type="text" id="name" class="input-xxlarge" data-bind="value:name" maxlength="256"
            ...
            %{--</div>--}%
            <div class="control-group required">
                <label class="control-label span3" for="description">Description: <fc:iconHelp><g:message
                        code="organisation.description.help"/></fc:iconHelp></label>

                <div class="controls span9">
                    <textarea rows="3" class="input-xxlarge" data-bind="value:description"
            ...
            <div class="control-group">
                <label class="control-label span3" for="url">Web Site URL: <fc:iconHelp><g:message
                        code="organisation.webUrl.help"/></fc:iconHelp></label>

                <div class="controls span9">
                    <input type="text" class="input-xxlarge" id="url" data-bind="value:url"
    ...
    <div class="row-fluid">
        <div class="well">
            ...
            <div class="control-group">
                <label class="control-label span3" for="logo">Organisation Logo<fc:iconHelp><g:message
                ...
                <div class="span6" style="text-align:center;background:white">
                    ...
                    <div class="well" style="padding:0;width:200px;height:150px;line-height:146px;display:inline-block">
                        <img style="max-width:100%;max-height:100%" alt="No image provided"
            ...
            <div class="control-group">
                <label class="control-label span3" for="mainImage">Feature Graphic<fc:iconHelp><g:message
                ...
                <span class="span3">
                    <span class="btn fileinput-button pull-right"
                          ...
                          data-owner-type="organisationId"
                          data-owner-id="${organisation?.organisationId}"
                          data-bind="stagedImageUpload:documents, visible:!mainImageUrl()"><i
                            class="icon-plus"></i> <input
