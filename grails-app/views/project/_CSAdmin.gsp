    ...
    <div class="row mt-4">
        <div class="col-12 col-lg-2">
            <ul id="ul-cs-internal-project-admin" class="nav flex-row flex-lg-column nav-pills nav-fill">
                ...
                <li class="nav-item text-left"><a class="nav-link" href="#edit-documents" id="edit-documents-tab" data-toggle="tab"><i class="fas fa-chevron-right"></i> <g:message code="${hubConfig.getTextForResources(grailsApplication.config.content.defaultOverriddenLabels)}"/></a></li>
        ...
        <div class="col-12 col-lg-10">
            <div class="tab-content">
                ...
                <div id="edit-documents" class="tab-pane" role="tabpanel">
                    <h4 class="mt-3 mt-lg-0"><g:message code="Project ${hubConfig.getTextForResources(grailsApplication.config.content.defaultOverriddenLabels)}"/></h4>
                    <div class="row">
                        <div class="col-12">
