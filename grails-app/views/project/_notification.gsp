...
<form>
    <div class="mb-3">
        ...
        <div class="col-sm-8">
            <input class="full-collapse-horizontal" type="text" data-bind="value: subject">
        </div>
    </div>
    <div class="mb-3">
        <label class="col-sm-4 col-form-label"><g:message code="notification.body"/></label>
        <div class="col-sm-8">
            <textarea class="full-collapse-horizontal" data-bind="value: body" rows="10"></textarea>
        </div>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <div class="col-sm-8">
            <div class="row">
                <div class="col-12">
                    <table class="table table-striped table-bordered table-hover full-collapse-horizontal" id="notification-member-list" data-bind="if: transients.members().length">
                        <thead>
                        <th>User Id</th>
                        <th>User Name</th>
                        <th>Role</th>
