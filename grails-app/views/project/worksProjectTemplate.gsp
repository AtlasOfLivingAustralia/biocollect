...
<head>
    ...
    var fcConfig = {
        ...
        outputTargetMetadata: <fc:modelAsJavascript model="${outputTargetMetadata?:[]}" />,
        activityTypes: <fc:modelAsJavascript model="${activityTypes?:[]}"/>,
        themes: <fc:modelAsJavascript model="${themes?:[]}" />,
        sites: <fc:modelAsJavascript model="${project?.sites ?: []}"/>,
        siteIds: <fc:modelAsJavascript model="${project.mapConfiguration?.sites ?: []}" />,
