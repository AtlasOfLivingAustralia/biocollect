        ...
        <div class="row mb-2">
            <div class="col-sm-6 col-lg-3">
                <div class="input-group">
                    ...
                    <select id="associatedProgram" class="custom-select" data-bind="options: associatedPrograms, value: associatedProgramFilterField"></select>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="input-group">
                    ...
                    <select id="electorate" class="custom-select" data-bind="options: electorates, optionsText: 'name', optionsValue: 'id', value:electorateFilterField"></select>
                </div>
            </div>

            <div class="col-sm-6 col-lg-3">
                <div class="input-group">
                    <button id="downloadReport" class="btn btn-primary-dark" data-bind="click: downloadReport()">Download</button>
                </div>
            </div>
        </div>
