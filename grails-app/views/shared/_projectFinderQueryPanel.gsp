    ...
    <div id="pt-selectors" class="well">
        ...
        <section class="filter-section">
            ...
            <!-- ko foreach:selectedFacets -->
                <li data-bind="style: { 'margin-left': ($index()*10) + 'px'}"><strong data-bind="if: exclude">[EXCLUDE]</strong> <span data-bind="text: displayNameWithoutCount()">nbsp;</span><a href="#" data-bind="click: remove"><i class="icon-remove"></i></a></li>
            <!-- /ko  -->
            </ul>
        </section>
