...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'grails-app/assets/vendor/bootstrap/js/bootstrap.js',
            'grails-app/assets/vendor/bootbox/bootbox.min.js',
            'grails-app/assets/javascripts/editable-table.js',
            'grails-app/assets/javascripts/fundingBudget.js',
            'grails-app/assets/javascripts/projects.js',
            'grails-app/assets/javascripts/map-configuration.js',
            'grails-app/assets/javascripts/risks.js',
            'grails-app/assets/javascripts/issues.js',
            ...
            'grails-app/assets/javascripts/meriPlan.js',
