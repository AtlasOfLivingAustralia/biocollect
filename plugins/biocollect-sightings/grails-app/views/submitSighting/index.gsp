...
<head>
    ...
    <r:require modules="fileuploads, exif, moment, pigeonhole, bs2_datepicker, udraggable, fontawesome, purl, submitSighting, jquery-ui, inview, identify, leafletGoogle"/>
            ...
            <form id="sightingForm" action="${g.createLink(controller:'submitSighting', action:'upload')}" method="POST">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span8">
                            <div id="showConfident" class="control-group">
                                ...
                                <input class="span12 ${hasErrors(bean:sighting,field:'scientificName','validationErrors')}" id="speciesLookup" type="text" placeholder="Start typing a species name (common or latin)">
                            </div>
                            ...
                            <div id="identificationChoice" class="form-group">
                                <label for="speciesGroups"><strong>(Optional)</strong> Tag this sighting with species group and/or sub-group:</label>
                                <div class="row-fluid">
                                    <div class="span6">
                                        <g:select name="tag" from="${speciesGroupsMap?.keySet()}" id="speciesGroups" class="span12 input-sm ${hasErrors(bean:sighting,field:'scientificName','validationErrors')}" noSelection="['':'-- Species group --']"/>
                                    </div>
                                    <div class="span6">
                                        <g:select name="tag" from="${[]}" id="speciesSubgroups" class="span12 input-sm" noSelection="['':'-- Subgroup (select a group first) --']"/>
                                    </div>
                                </div>
                            </div>
                        ...
                        <g:if test="${grailsApplication.config.identify.enabled.toBoolean()}">
                            <div id="identifyHelpTrigger">Unsure of the species name? Try the location-based: <a href="#identifyHelpModal" class="identifyHelpTrigger btn btn-primary btn-small"><i class="fa fa-search"></i> Species Suggestion Tool</a></div>
                        </g:if>
                    </div>
                </div>
                ...
                <div class="boxed-heading" id="media" data-content="Images">
                    ...
                    <div class="controls">
                        ...
                        <span class="btn btn-primary fileinput-button control-label" title="Select one or more photos to upload (you can also simply drag and drop files onto the page).">
                        ...
                        <span style="display: inline-block;"><strong>(Optional)</strong> Add one or more images. Image metadata will be used to automatically set date and location fields (where available)
                            <br><strong><i class="fa fa-info-circle"></i> Hint:</strong> you can drag and drop files onto this window</span>
                        <br>
                    </div>
                    <br/>
                    ...
                    <div id="imageLicenseDiv" class="form-horizontal">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <g:select from="${grailsApplication.config.sighting.licenses}" name="imageLicense" class="span5" id="imageLicense" value="${sighting?.multimedia ? sighting?.multimedia?.get(0)?.license : ''   }"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="span6" id="mapWidget">
                            <div class="row-fluid">
                                <div class="span4">
                                    <button class="btn btn-default span11" id="useMyLocation">
                                        <i class="fa fa-location-arrow fa-lg" style="margin-left:-2px;margin-right:2px;"></i> Current location <r:img uri="/images/spinner.gif" class="spinner0" style="display:none;height: 18px;"/>
                                    </button>
                                </div>
                                ...
                                <div class="span7">
                                    <div class="input-append span12">
                                        <input id="geocodeinput" class="span10" style="margin-left: 10px;" type="text" placeholder="Enter an address, location or lat/lng">
                            ...
                            <div style="position:relative;">
                                ...
                                <div class="" id="mapTip"><strong><i class="fa fa-info-circle"></i> Hint:</strong> drag the marker to fine-tune your location
                                    <img class="drag" id="markerIcon" src="${r.resource(dir: 'vendor/leaflet-0.7.3/images', file: 'marker-icon.png', plugin:'fieldcapture-sightings')}" alt="marker icon" />
                                </div>
                            </div>
                        ...
                        <div class="span6 form-horizontal" style="margin-bottom: 0px;">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="decimalLatitude" id="decimalLatitude" class="form-control ${hasErrors(bean:sighting,field:'decimalLatitude','validationErrors')}" value="${sighting?.decimalLatitude}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="decimalLongitude" class="control-label">Longitude (decimal):</label>
                                <div class="controls">
                                    <input type="text" name="decimalLongitude" id="decimalLongitude" class="form-control ${hasErrors(bean:sighting,field:'decimalLongitude','validationErrors')}" value="${sighting?.decimalLongitude}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="coordinateUncertaintyInMeters" class="control-label">Accuracy (metres):</label>
                                <div class="controls">
                                    <g:select from="${grailsApplication.config.accuracyValues?:[0,10,50,100,500,1000,10000]}" id="coordinateUncertaintyInMeters" class="form-control  ${hasErrors(bean:sighting,field:'coordinateUncertaintyInMeters','validationErrors')}" name="coordinateUncertaintyInMeters" value="${sighting?.coordinateUncertaintyInMeters?:50}" noSelection="['':'--']"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="georeferenceProtocol" class="control-label">Source of coordinates:</label>
                                <div class="controls">
                                    <g:select from="${coordinateSources}" id="georeferenceProtocol" class="form-control " name="georeferenceProtocol" value="${sighting?.georeferenceProtocol}"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="locality" class="control-label">Matched locality:</label>
                                <div class="controls">
                                    <textarea id="locality" name="locality" class="form-control disabled" rows="3">${sighting?.locality}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="locationRemark" class="control-label">Location notes:</label>
                                <div class="controls">
                                    <textarea id="locationRemark" name="locationRemark" class="form-control" rows="3" value="${sighting?.decimalLatitude}">${sighting?.locationRemark}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-append">
                                        <g:select name="bookmarkedLocations" id="bookmarkedLocations" from="${[]}" optionKey="" optionValue="" noSelection="['':'-- saved locations --']"/>
                                        <span class="input-group-btn">
                                            <button id="bookmarkLocation" class="btn btn-primary disabled" disabled="disabled" title="Save this location"><i class="fa fa-save"></i> Save</button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="boxed-heading" id="details" data-content="Details">
                    <div class="row-fluid">
                        <div class="span6 form-horizontal">
                            <div class="control-group">
                                <label for="dateStr" class="span2 control-label">Time:</label>
                                <div class="controls span10">
                                    <div class="input-append date" id='datetimepicker1'>
                                        <input type="text" id="dateStr" name="dateStr" class="${hasErrors(bean:sighting,field:'eventDate','validationErrors')}" placeholder="DD-MM-YYYY" value="${si.getDateTimeValue(date: sighting?.eventDate, part: 'date')}"/>
                            ...
                            <div class="control-group">
                                <label for="timeStr" class="span2 control-label">Date:</label>
                                <div class="controls span10">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls span10">
                                    <g:select from="${1..99}" name="individualCount" class="input-sm form-control smartspinner" value="${sighting?.individualCount}" data-validation-engine="validate[custom[integer], min[1]]" id="individualCount"/>
                        ...
                        <div class="span6">
                            <section class="sightings-block form-horizontal" style="vertical-align: top;">
                                <div class="control-group">
                                    ...
                                    <div class="controls span10">
                                        <textarea name="occurrenceRemarks" rows="6" cols="90" class="form-control" id="occurrenceRemarks">${sighting?.occurrenceRemarks}</textarea>
                                    </div>
                                </div>
                            </section>
                        </div>
