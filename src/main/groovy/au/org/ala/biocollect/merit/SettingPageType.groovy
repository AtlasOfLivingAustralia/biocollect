...
enum SettingPageType {
    ...
    DASHBOARD_CONFIG_1("dashboardConfig1", "Dashboard configurations", "fielddata.dashboard.dashboardConfig1"),
    DASHBOARD_CONFIG_2("dashboardConfig2", "Dashboard configurations", "fielddata.dashboard.dashboardConfig2")
